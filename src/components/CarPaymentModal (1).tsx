...
export const CarPaymentModal: React.FC<CarPaymentModalProps> = ({
  ...
  const [depositAmount, setDepositAmount] = useState<number>(() => {
    if (purpose === 'listing_fee') return LISTING_FEE_ETB;
  ...
  const handleSubmitPayment = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const generatedReceipt: ReservationReceipt = {
        ...
        carTitle: car ? `${car.year} ${car.make} ${car.model}` : `Seller Listing Fee (${LISTING_FEE_ETB} ETB, One-Time)`,

    ...
    <header className="sticky top-0 z-40 w-full shadow-lg">
      ...
      <div className="bg-[#071739] text-white px-4 sm:px-8 py-3.5 border-b border-blue-950">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          {/* Logo: flat mark + wordmark, no card or circle backing */}
          <div
            className="cursor-pointer flex items-center gap-2 transition-transform hover:scale-[1.01]"
          ...
          >
            ...
            />
            <span
              className="text-base sm:text-lg font-serif font-semibold text-white tracking-tight whitespace-nowrap"

...
export const ListingDetailModal: React.FC<ListingDetailModalProps> = ({
  ...
  // Close on the phone/browser back button instead of exiting the whole site.
  useModalBackClose(!!listing, onClose);

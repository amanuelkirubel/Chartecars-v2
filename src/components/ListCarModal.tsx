  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!isAdminLoggedIn) {
      ...
      if (!cleanRef || cleanRef.length < 5) {
        setErrorMsg(lang === 'am'
          ? 'ክፍያ ሳይፈጽሙ መኪናዎን መዘርዘር አይችሉም! እባክዎ የ50 ብር መዘርዘሪያ ክፍያ ከተዘረዘሩት አካውንቶች (ቴሌብር 0970181259፣ ኤም-ፔሳ 0710783877 ወይም 0970181259፣ ንግድ ባንክ 1000099751715፣ አቢሲኒያ 152910851፣ ቡና 1199501004634፣ ዳሸን 5230712330011፣ አዋሽ 01320258408900፣ አንበሳ 00311034687-89) በአንዱ ከፍለው የደረሰኝ ቁጥር ያስገቡ።'
          : 'Payment is strictly required! No one can list their car without paying the 50 ETB listing fee. Please pay via Telebirr (0970181259), M-Pesa (0710783877 or 0970181259), CBE (1000099751715), BoA (152910851), Buna (1199501004634), Dashen (5230712330011), Awash (01320258408900), or Lion Bank (00311034687-89) and enter your transaction reference.');
        return;
      }

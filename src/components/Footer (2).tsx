          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2.5 text-xs">
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="flex flex-col">
                  <a href="mailto:chartecars7@gmail.com" className="hover:text-white">
                    chartecars7@gmail.com
                  </a>
                  <a href="mailto:chartecars@gmail.com" className="hover:text-white">
                    chartecars@gmail.com
                  </a>
                  <a href="mailto:chartecars9@gmail.com" className="hover:text-white">
                    chartecars9@gmail.com
                  </a>
                  <a href="mailto:emanuelkirubel@gmail.com" className="hover:text-white">
